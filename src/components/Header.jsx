                        ...
                        <div className="ml-3 flex-1 min-w-0">
                          ...
                          <div className="flex items-center mt-1">
                            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
                              ...
                              client.status === 'FTD RETENTION' ? 'bg-indigo-100 text-indigo-800' :
                              client.status === 'Call Again' ? 'bg-orange-100 text-orange-800' :
                              client.status === 'No Answer' ? 'bg-pink-100 text-pink-800' :
                              client.status === 'NA5UP' ? 'bg-teal-100 text-teal-800' :
                              client.status === 'Not Interested' ? 'bg-gray-100 text-gray-800' :
                              client.status === 'Hang Up' ? 'bg-purple-100 text-purple-800' :
